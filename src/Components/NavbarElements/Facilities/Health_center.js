...
const Healthcentre = ()=>{
   ...
   <Container>
       <Row>
           <Col>
           <h3 style={{borderBottom:"2px solid #f03c02",paddingTop:20}}>SVU Health Center</h3> 
                <p>
                ...
                <ul>
                    ...
                    <li>Employees of S.V.University and their dependent family members like parents andunmarried children</li>
