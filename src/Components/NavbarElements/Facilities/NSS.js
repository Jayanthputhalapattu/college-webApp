  ...
  return(
      <Container>
          <Row>
              ...
              <ul>
                  <li>To promote personality development among students through community service.</li>
                  <li>To instill a sense of discipline among students</li>
                  <li>To make students physically fit for nation building activities.</li>
                  <li>To direct students energies to right causes.</li>
              ...
              <ul>
                  <li>120 hours of service during an academic year</li>
                  <li>They have to work on Sundays and evenings to complete this target service.</li>
                  <li>One special camp in a year during vacation.</li>
                  <li>
Volunteers are provided with refreshment whenever they work.</li>
              </ul>
              <h4 style={{borderBottom:"2px solid #f03c02",paddingTop:20}}>Issue of certificates</h4> 
              <ul>
                  <li>
